...
def archivos():
    ...
    df1 = pd.read_csv('./src/files/productos.csv', on_bad_lines='skip')
    df2 = pd.read_csv('./src/files/clientes.csv', on_bad_lines='skip')
    df3 = pd.read_csv('./src/files/ventas.csv', on_bad_lines='skip')
